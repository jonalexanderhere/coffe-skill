      ...
      <main className="pt-24 pb-16 min-h-screen bg-white dark:bg-charcoal">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {events.length > 0 ? (
            ...
            <div className="text-center py-20 bg-coffee-50/30 dark:bg-charcoal-light/30 rounded-2xl border border-dashed border-coffee-200 dark:border-charcoal-200">
              <Calendar className="mx-auto text-coffee-300 mb-4" size={48} />
              <h3 className="text-lg font-semibold text-coffee-700 dark:text-white mb-1">Belum ada event</h3>
              <p className="text-sm text-coffee-400">Nantikan update event terbaru dari CoffeeSkill segera!</p>
            </div>
          )}
        </div>
      </main>
